...
This packages contains the SDL_net.framework for OS X. Conforming with Apple guidelines, this framework contains both the SDL runtime component and development header files.

Requirements:
You must have the SDL.framework installed.

To Install:
Copy the SDL_net.framework to /Library/Frameworks
