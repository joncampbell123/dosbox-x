...
As of DOSBox-X version 0.83.15, DOSBox-X also supports native DOS/V service and JEGA (AX) emulations so that you can also run programs or games designed for them in these modes.
