...
== Known limitations
- When booting a guest OS, such a Windows 98 in DOSBox-X, so-called folder mounts are not supported.
Any folders of the host you mount before starting Windows 95 will **NOT** be available in Windows 98.
