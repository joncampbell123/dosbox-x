...
For example, the Chinese (Simplified & Traditional), English (United States), French, Japanese, Portuguese (Brazilian), Spanish, and Turkic language files for DOSBox-X are available from:
