...
== Known limitations
- When booting a guest OS, such a Windows ME in DOSBox-X, so-called folder mounts are not supported.
Any folders of the host you mount before starting Windows ME will **NOT** be available in Windows ME.
