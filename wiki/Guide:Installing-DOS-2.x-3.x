...
<h1 id="_installing_dos_2_x_3_x_in_dosbox_x" class="sect0">Installing DOS 2.x-3.x in DOSBox-X</h1>
<div class="openblock partintro">
<div class="content">
<div id="toc" class="toc">
<div id="toctitle" class="title">Table of Contents</div>
<ul class="sectlevel0">
<li><a href="#_installing_dos_2_x_3_x_in_dosbox_x">Installing DOS 2.x-3.x in DOSBox-X</a>
<ul class="sectlevel1">
...
<li><a href="#_this_applies_to">This applies to</a></li>
...
<li>
<p>First to support 5.25" 9-sector 180KB (SSDD) and 360KB disks (DSDD)</p>
</li>
</ul>
</div>
</div>
...
<ul>
<li>
<p>Adds features for networking (e.g. IFS, remote file and print API)</p>
</li>
</ul>
</div>
</div>
...
<div class="sect1">
<h2 id="_this_applies_to">This applies to</h2>
<div class="sectionbody">
<div class="ulist">
<ul>
<li>
...
<ul>
<li>
<p><a href="http://www.os2museum.com/wp/dos/dos-2-0-and-2-1/" class="bare">http://www.os2museum.com/wp/dos/dos-2-0-and-2-1/</a></p>
</li>
<li>
<p><a href="http://www.os2museum.com/wp/dos/dos-3-0-3-2/" class="bare">http://www.os2museum.com/wp/dos/dos-3-0-3-2/</a></p>
</li>
<li>
<p><a href="http://www.os2museum.com/wp/dos/dos-3-3/" class="bare">http://www.os2museum.com/wp/dos/dos-3-3/</a></p>
</li>
</ul>
</div>
</div>
...
<td class="tableblock halign-left valign-top"><p class="tableblock">Requires machine=tandy. Could read a HDD image created with PC DOS 2.10, but could not boot from it (after SYS), perhaps with HFORMAT which I could not easily locate&#8230;&#8203;</p></td>
</tr>
<tr>
<td class="tableblock halign-left valign-top"><p class="tableblock">MS-DOS 2.11</p></td>
...
<div class="content">
<pre> IMGMAKE hdd.img -t hd -size 31 -nofs
 IMGMOUNT 2 hdd.img -size 512,32,2,992 -fs none</pre>
</div>
</div>
...
<div class="literalblock">
<div class="content">
<pre> BOOT dos.img</pre>
</div>
</div>
<div class="paragraph">
<p>Assuming that your uncompressed DOS 3.0-3.2 image is named dos.img and in your current working directory, it should boot DOS from the diskette image.</p>
</div>
<div class="imageblock">
<div class="content">
...
<div class="paragraph">
<p>These early DOS versions did not have an installer, so the preparation and installation is a manual process.</p>
</div>
<div class="paragraph">
...
<div class="paragraph">
<p>After it is finished, press any key and DOS will reboot DOSBox-X and your again at the DOSBox-X <code>Z:\&gt;</code> prompt.
At this point the HDD image is partitioned, but not yet formatted or made bootable, so that is what you need to do next.</p>
</div>
<div class="paragraph">
<p>Since there is now a partition, it is no longer necessary to specify the geometry.</p>
</div>
<div class="literalblock">
<div class="content">
<pre> IMGMOUNT 2 hdd.img -fs none
 BOOT dos.img</pre>
</div>
</div>
<div class="paragraph">
...
<td class="content">
As a IBM PC DOS exclusive, starting with PC DOS 3.0, there is the <code><a href="https://web.csulb.edu/~murdock/select.html">SELECT.COM</a></code> program which formats and transfers the OS from one diskette to another.
...
You are again at the DOSBox-X <code>Z:\&gt;</code> prompt.</p>
</div>
<div class="paragraph">
...
So your can boot from the HDD image with the following commands instead.</p>
</li>
</ul>
</div>
<div class="literalblock">
