...
In actuality, it also needs at least DOS 2.0, and the two disk drives are not mandatory if there is a harddisk.
...
NOTE: In the version shown, it is option 1, but in other releases it is option 2.
