...
NOTE: The CPU type for ``3dfxSpl2.dll`` and DOSBox-X needs to match for this to work. So if you have a x86 32bit ``3dfxSpl2.dll``, you need to use a x86 32bit ``dosbox-x.exe``.
