                ...
                for (Bitu row=0;row < ttf.lins;row++) {
                    ...
                    for (Bitu col=0;col < ttf.cols;col++) {
                        ...
                        *draw = ttf_cell();
                        ...
                        if (dex) {
                            (*draw).chr = ' ';
                            if (col && failName == "SarasaGothicFixed" && (last == 0x2014 || last == 0x2500 || last == 0x2501 || last == 0x250f || last == 0x2517 || last == 0x251c || last == 0x2520 || last == 0x2523 || last == 0x252c || last == 0x252f || last == 0x2533 || last == 0x2534 || last == 0x2537 || last == 0x253b || last == 0x253c || last == 0x2543 || last == 0x2544 || last == 0x2545 || last == 0x2546)) {
                               (*draw).unicode = 1;
