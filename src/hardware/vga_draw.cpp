...
bool connectLeft(uint8_t c, bool db, bool first) {
    if (first) return true;
    if (db) return c == 200 || c == 201 || c == 202 || c == 203 || c == 204 || c == 205 || c == 206;
    else return c == 192 || c == 193 || c == 194 || c == 195 || c == 196 || c == 197 || c == 218;
}

bool connectRight(uint8_t c, bool db, bool first) {
    if (!first) return true;
    if (db) return c == 185 || c == 187 || c == 188 || c == 202 || c == 203 || c == 205 || c == 206;
    else return c == 180 || c == 191 || c == 193 || c == 194 || c == 196 || c == 197 || c == 217;
}
