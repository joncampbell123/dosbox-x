...
int main(int argc, char* argv[]) SDL_MAIN_NOEXCEPT {
    ...
    // DEBUG
    static_assert(bitop::bitcount2masklsb<0u>() == 0u, "whoops");
    static_assert(bitop::bitcount2masklsb<1u>() == 1u, "whoops");
    static_assert(bitop::bitcount2masklsb<2u>() == 3u, "whoops");
    static_assert(bitop::bitcount2masklsb<bitop::type_bits<>()>() == bitop::allones(), "whoops");
    static_assert(bitop::allones<uint32_t>() == (uint32_t)0xFFFFFFFFUL, "whoops");
    static_assert(bitop::allzero<uint32_t>() == (uint32_t)0, "whoops");
    static_assert(bitop::allones<uint64_t>() == (uint64_t)0xFFFFFFFFFFFFFFFFULL, "whoops");
    static_assert(bitop::allzero<uint64_t>() == (uint64_t)0, "whoops");
    static_assert((~bitop::allones<uint32_t>()) == bitop::allzero<uint32_t>(), "whoops");
    static_assert((~bitop::allzero<uint32_t>()) == bitop::allones<uint32_t>(), "whoops");
    assert(bitop::type_bits<uint64_t>() == 64u);
    assert(bitop::type_bits<uint32_t>() == 32u);
    assert(bitop::type_bits<uint16_t>() == 16u);
    assert(bitop::type_bits<uint8_t>() == 8u);
    assert(bitop::bit2mask(0u) == 1u);
    assert(bitop::bit2mask(8u) == 256u);
    assert(bitop::bit2mask<8u>() == 256u);
    static_assert(bitop::bit2mask<9u>() == 512u, "whoops");
    static_assert(bitop::bit2mask<33u,uint64_t>() == (1ull << 33ull), "whoops");
    static_assert(bitop::bitlength(0u) == 0u, "whoops");
    static_assert(bitop::bitlength(1u) == 1u, "whoops");
    static_assert(bitop::bitlength(2u) == 2u, "whoops");
    static_assert(bitop::bitlength(3u) == 2u, "whoops");
    static_assert(bitop::bitlength(4u) == 3u, "whoops");
    static_assert(bitop::bitlength(7u) == 3u, "whoops");
    static_assert(bitop::bitlength(8u) == 4u, "whoops");
    static_assert(bitop::bitlength(~0u) == bitop::type_bits(), "whoops");
