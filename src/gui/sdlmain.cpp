    ...
    if (fsize==2)
        ...
        if (*colors) {
            if (setColors(colors,-1)) {
                ...
                colorsLocked = true;
                for (int i = 0; i < 16; i++) {
                    rgbColors[i].red = altBGR1[i].red;
                    rgbColors[i].green = altBGR1[i].green;
                    rgbColors[i].blue = altBGR1[i].blue;
                }
            } else {
...
//  0       1       2       3       4       5       6       7
    ...
    0x2418, 0x2419, 0x241A, 0x241B, 0x241C, 0x241D, 0x241E, 0x241F,                 // 0x18-0x1F
