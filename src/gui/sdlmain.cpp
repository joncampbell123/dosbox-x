...
std::map<uint8_t, uint8_t> pc98boxconvert {
    {0xBA, 0x46}, {0xBB, 0x56}, {0xBC, 0x5E}, {0xC8, 0x5A}, {0xC9, 0x52}, {0xCD, 0x44},
};
std::map<uint16_t, uint8_t> pc98boxmap {
    {0x240B, 0xC4}, {0x250B, 0xCD}, {0x260B, 0xB3}, {0x270B, 0xBA}, {0x300B, 0xDA}, {0x330B, 0xC9}, {0x340B, 0xBF},
    {0x370B, 0xBB}, {0x380B, 0xC0}, {0x3B0B, 0xC8}, {0x3C0B, 0xD9}, {0x3F0B, 0xBC}, {0x440B, 0xC7}, {0x4C0B, 0xB6},
};
