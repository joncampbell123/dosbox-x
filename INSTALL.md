...
* [dosbox-x-win32-0.83.17-setup.exe](https://github.com/joncampbell123/dosbox-x/releases/download/dosbox-x-v0.83.17/dosbox-x-win32-0.83.17-setup.exe) (32-bit Windows builds; Windows XP or later)
* [dosbox-x-win64-0.83.17-setup.exe](https://github.com/joncampbell123/dosbox-x/releases/download/dosbox-x-v0.83.17/dosbox-x-win64-0.83.17-setup.exe) (64-bit Windows builds; Windows Vista or later)
...
* [dosbox-x-vsbuild-win32-20210831224158.zip](https://github.com/joncampbell123/dosbox-x/releases/download/dosbox-x-v0.83.17/dosbox-x-vsbuild-win32-20210831224158.zip) (Visual Studio Win32 builds)
* [dosbox-x-vsbuild-win64-20210831224158.zip](https://github.com/joncampbell123/dosbox-x/releases/download/dosbox-x-v0.83.17/dosbox-x-vsbuild-win64-20210831224158.zip) (Visual Studio Win64 builds)
* [dosbox-x-vsbuild-arm32-20210831224158.zip](https://github.com/joncampbell123/dosbox-x/releases/download/dosbox-x-v0.83.17/dosbox-x-vsbuild-arm32-20210831224158.zip) (Visual Studio ARM32 builds)
* [dosbox-x-vsbuild-arm64-20210831224158.zip](https://github.com/joncampbell123/dosbox-x/releases/download/dosbox-x-v0.83.17/dosbox-x-vsbuild-arm64-20210831224158.zip) (Visual Studio ARM64 builds)
* [dosbox-x-mingw-win32-20210831230534.zip](https://github.com/joncampbell123/dosbox-x/releases/download/dosbox-x-v0.83.17/dosbox-x-mingw-win32-20210831230534.zip) (MinGW Win32 builds)
* [dosbox-x-mingw-win64-20210901044459.zip](https://github.com/joncampbell123/dosbox-x/releases/download/dosbox-x-v0.83.17/dosbox-x-mingw-win64-20210901044459.zip) (MinGW Win64 builds)
...
If you use macOS as your operating system, we also release portable packages for the macOS (64-bit) platform. For the current DOSBox-X version 0.83.17, the official macOS packages are available as zip packages:

For 64-bit Intel-based macOS:
* [dosbox-x-macosx-x86_64-20210831231846.zip](https://github.com/joncampbell123/dosbox-x/releases/download/dosbox-x-v0.83.17/dosbox-x-macosx-x86_64-20210831231846.zip)

For 64-bit ARM-based macOS:
* [dosbox-x-macosx-arm64-20210831230855.zip](https://github.com/joncampbell123/dosbox-x/releases/download/dosbox-x-v0.83.17/dosbox-x-macosx-arm64-20210831230855.zip)
...
* [dosbox-x-macosx-0.83.17-high-sierra.zip](https://github.com/joncampbell123/dosbox-x/releases/download/dosbox-x-v0.83.17/dosbox-x-macosx-0.83.17-high-sierra.zip)
...
Full source code packages of DOSBox-X are also available in both zip and tar.gz formats. Both contain the full source code, but you probably want to download the source code in zip format if you are using Windows, and the source code in tar.gz format if you are using Linux. For the current DOSBox-X version 0.83.17, the source code packages are:

* [dosbox-x-v0.83.17.zip](hhttps://github.com/joncampbell123/dosbox-x/archive/refs/tags/dosbox-x-v0.83.17.zip)
* [dosbox-x-v0.83.17.tar.gz](https://github.com/joncampbell123/dosbox-x/archive/refs/tags/dosbox-x-v0.83.17.tar.gz)

If you prefer you can compile DOSBox-X from the source code by yourself. The source code packages as listed in the [Releases](https://github.com/joncampbell123/dosbox-x/releases) page contain the source code for that released version, and in this example the current DOSBox-X 0.83.17 version. On the other hand, if you are looking for the latest source code of DOSBox-X (including the most recent development changes in the source code), you may want to use the source code in the repository instead, or you can browse the latest source code using [Doxygen](https://dosbox-x.com/doxygen/html/index.html).
