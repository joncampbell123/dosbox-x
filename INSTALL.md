...
You probably want to use the all-in-one Windows installation packages for the ease of installation, which are especially recommended for new and non-expert users. With the installer the installation process will be automated while allowing you to change the install folder and the default build to run if you prefer (and the option to install all builds to subdirectories), so that you will be able to start DOSBox-X as soon as the installation ends. A quick start guide is also included in the package, and shell context menus can be automatically added for a fast launch of DOSBox-X from the Windows Explorer. The Windows installers for the current DOSBox-X version 0.83.19 are available from:

* [dosbox-x-win32-0.83.19-setup.exe](https://github.com/joncampbell123/dosbox-x/releases/download/dosbox-x-v0.83.19/dosbox-x-win32-0.83.19-setup.exe) (32-bit Windows builds; Windows XP or later)
* [dosbox-x-win64-0.83.19-setup.exe](https://github.com/joncampbell123/dosbox-x/releases/download/dosbox-x-v0.83.19/dosbox-x-win64-0.83.19-setup.exe) (64-bit Windows builds; Windows Vista or later)
...
Apart from the Windows installers, you can find six zip packages (three before 0.83.13) for each DOSBox-X version for the Windows platform in the [Releases](https://github.com/joncampbell123/dosbox-x/releases) page as an alternative way to install DOSBox-X. These zip files are portable packages containing binaries built with Visual Studio 2019 (Win32, Win64, ARM32, ARM64 respectively), MinGW (Win32 and Win64 respectively). For the current DOSBox-X version 0.83.19, these portable Visual Studio builds are separately available from:

* [dosbox-x-vsbuild-win32-20211101135026.zip](https://github.com/joncampbell123/dosbox-x/releases/download/dosbox-x-v0.83.19/dosbox-x-vsbuild-win32-20211101135026.zip) (Visual Studio Win32 builds)
* [dosbox-x-vsbuild-win64-20211101135026.zip](https://github.com/joncampbell123/dosbox-x/releases/download/dosbox-x-v0.83.19/dosbox-x-vsbuild-win64-20211101135026.zip) (Visual Studio Win64 builds)
* [dosbox-x-vsbuild-arm32-20211101135026.zip](https://github.com/joncampbell123/dosbox-x/releases/download/dosbox-x-v0.83.19/dosbox-x-vsbuild-arm32-20211101135026.zip) (Visual Studio ARM32 builds)
* [dosbox-x-vsbuild-arm64-20211101135026.zip](https://github.com/joncampbell123/dosbox-x/releases/download/dosbox-x-v0.83.19/dosbox-x-vsbuild-arm64-20211101135026.zip) (Visual Studio ARM64 builds)
...
If you use macOS as your operating system, we also release portable packages for the macOS (64-bit) platform. For the current DOSBox-X version 0.83.19, the official macOS packages are available as zip packages:

For 64-bit Intel-based macOS:
* [dosbox-x-macosx-x86_64-20211101101155.zip](https://github.com/joncampbell123/dosbox-x/releases/download/dosbox-x-v0.83.19/dosbox-x-macosx-x86_64-20211101101155.zip)

For 64-bit ARM-based macOS:
* [dosbox-x-macosx-arm64-20211101100925.zip](https://github.com/joncampbell123/dosbox-x/releases/download/dosbox-x-v0.83.19/dosbox-x-macosx-arm64-20211101100925.zip)
...
* [dosbox-x-macosx-0.83.19-high-sierra.zip](https://github.com/joncampbell123/dosbox-x/releases/download/dosbox-x-v0.83.19/dosbox-x-macosx-0.83.19-high-sierra.zip)
...
Full source code packages of DOSBox-X are also available in both zip and tar.gz formats. Both contain the full source code, but you probably want to download the source code in zip format if you are using Windows, and the source code in tar.gz format if you are using Linux. For the current DOSBox-X version 0.83.19, the source code packages are:

* [dosbox-x-v0.83.19.zip](https://github.com/joncampbell123/dosbox-x/archive/refs/tags/dosbox-x-v0.83.19.zip)
* [dosbox-x-v0.83.19.tar.gz](https://github.com/joncampbell123/dosbox-x/archive/refs/tags/dosbox-x-v0.83.19.tar.gz)

If you prefer you can compile DOSBox-X from the source code by yourself. The source code packages as listed in the [Releases](https://github.com/joncampbell123/dosbox-x/releases) page contain the source code for that released version, and in this example the current DOSBox-X 0.83.19 version. On the other hand, if you are looking for the latest source code of DOSBox-X (including the most recent development changes in the source code), you may want to use the source code in the repository instead, or you can browse the latest source code using [Doxygen](https://dosbox-x.com/doxygen/html/index.html).
