...
const struct opcode_t op_78_jcc = { // JS <d>                    0x78
	.opcode_name = "js",
	.pattern_sz = 1,
	.pattern = {0x78},
	.patparam = { CPUPPM_IMMEDIATEB },
...
const struct opcode_t op_79_jcc = { // JNS <d>                     0x79
	.opcode_name = "jns",
	.pattern_sz = 1,
	.pattern = {0x79},
	.patparam = { CPUPPM_IMMEDIATEB },
...
const struct opcode_t op_7a_jcc = { // JPE <d>                    0x7A
	.opcode_name = "jpe",
	.pattern_sz = 1,
	.pattern = {0x7A},
	.patparam = { CPUPPM_IMMEDIATEB },
...
const struct opcode_t op_7b_jcc = { // JPO <d>                     0x7B
	.opcode_name = "jpo",
	.pattern_sz = 1,
	.pattern = {0x7B},
	.patparam = { CPUPPM_IMMEDIATEB },
